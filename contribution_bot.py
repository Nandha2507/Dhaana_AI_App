...
async def export_excel(update: Update, context):
    user_id = update.effective_user.id
    allowed_users = [1255111776,7854166119]  # <-- Replace with your Telegram ID
    ...
    excel_path = f"contributions_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"

...
async def more_family_handler(update: Update, context) -> int:
    ...
    if query.data == "more_yes":
        ...
        # Prepare summary text for all family members
        summary_lines = [f"Summary of all contributions for {username}:"]
        for member in context.user_data['family_members']:
            summary_lines.append(
                f"\nMember: {member['family_member_name']}\n"
